...
1. Download [master](https://github.com/astrochili/defold-vscode-guide/archive/refs/heads/master.zip) as the template project or copy files into your existing project except `main`, `game.project` and `README.md`.

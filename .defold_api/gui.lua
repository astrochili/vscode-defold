...
---@return unknown cursor value number cursor value
...
---@return table clones a table mapping node ids to the corresponding nodes
...
function gui.set_material(node) end

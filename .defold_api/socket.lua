...
---@return table resolved a table with all information returned by the resolver, or if an error occurs, nil.
---@return string error the error message, or nil if no error occurred.
...
---@return string hostname the canonic host name of the given address, or nil in case of an error.
...
---@return string ip_address the first IP address found for the hostname, or nil in case of an error.
---@return table|string resolved a table with all information returned by the resolver, or if an error occurs, the error message string.
...
---@return master tcp_master a new IPv4 TCP master object, or nil in case of error.
---@return string error the error message, or nil if no error occurred.
function socket.tcp() end

---Creates and returns an IPv6 TCP master object. A master object can be transformed into a server object with the method listen (after a call to bind) or into a client object with the method connect. The only other method supported by a master object is the close method.
---Note: The TCP object returned will have the option "ipv6-v6only" set to true.
---@return master tcp_master a new IPv6 TCP master object, or nil in case of error.
---@return string error the error message, or nil if no error occurred.
...
---@return unconnected udp_unconnected a new unconnected IPv4 UDP object, or nil in case of error.
---@return string error the error message, or nil if no error occurred.
...
---@return unconnected udp_unconnected a new unconnected IPv6 UDP object, or nil in case of error.
---@return string error the error message, or nil if no error occurred.
